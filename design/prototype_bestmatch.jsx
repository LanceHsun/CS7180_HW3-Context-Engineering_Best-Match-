...
export default function BestMatch() {
  ...
  const navTab = (label, target) => (
    <button
      ...
      style={{
        ...
        border:
          page === target ? `1px solid ${C.blueBdr}` : "1px solid transparent",
  ...
  return (
    ...
    >
      ...
      {page === "onboarding" && (
        <div
          style={{ maxWidth: 640, margin: "0 auto", padding: "72px 24px 96px" }}
        >
          {/* Hero */}
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            >
              ...
              your best-matched roles straight to your inbox — daily or weekly.
            </p>
          </div>
            ...
            {!scanning && !parsed && (
              ...
              >
                ...
                <div style={{ textAlign: "center" }}>
                  <div
                    style={{ fontSize: 15, color: C.textSub, fontWeight: 500 }}
                  >
                  ...
                  <div
                    style={{ fontSize: 12, color: C.textMuted, marginTop: 5 }}
                  >
                    PDF only · Max 10 MB
                  </div>
                </div>
          ...
          {parsed && (
            <div style={{ animation: "slideDown 0.4s ease", marginTop: 22 }}>
              <Card>
                ...
                <div
                  style={{ height: 1, background: C.border, marginBottom: 24 }}
                />
      ...
      {page === "signin" && (
        <div
          style={{ maxWidth: 440, margin: "0 auto", padding: "96px 24px 80px" }}
        >
          ...
          <Card>
            {!magicSent ? (
              <>
                ...
                <button style={btnPrimary} onClick={() => setMagicSent(true)}>
                  Send Magic Link
                </button>
        ...
        >
          ...
          >
            ...
            <Card>
              ...
              <button style={{ ...btnPrimary, marginTop: 20, fontSize: 13 }}>
                Save Preferences
              </button>
            </Card>
          </div>
          ...
          <Card>
            ...
            >
              ...
              <span
                style={{ fontSize: 12, color: C.textMuted, marginTop: -14 }}
              >
        ...
        >
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 600 }}>
              You're all set! We're matching jobs for you.
            </div>
            <div
              style={{
                fontSize: 12,
        ...
        >
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: 13, color: C.textSub }}>
                Drop PDF here or{" "}
                <span style={{ color: C.accent, fontWeight: 600 }}>browse</span>
              </span>
            </div>
